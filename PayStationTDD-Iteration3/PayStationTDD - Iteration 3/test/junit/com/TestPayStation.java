...
public class TestPayStation {
  ...
  */
  ...
  public void Enter10And25Coins() throws IllegalCoinException {
	  ps.addPayment(10);
	  ps.addPayment(25);
	  assertEquals(35/5 * 2, ps.readDisplay(),0);
  }
  ...
  public void buyProducesValidReceipt() throws IllegalCoinException {
	  ...
	  ps.addPayment(25);
	  r = ps.buy();
	  assertEquals(100, r.value(),0);
  }

  @Test
  public void ReceiptCanStoreValues() {
	  r = new ReceiptImpl(16);
	  assertEquals(16, r.value(), 0);
  ...
  public void ClearingAfterABuyOperation() throws IllegalCoinException{
	  ps.addPayment(25);
	  r = ps.buy();
	  assertEquals(0, ps.readDisplay(),0);
  }
  
  @Test
  public void ClearingAfterACancelOperation() throws IllegalCoinException{
	  ps.addPayment(25);
	  ps.cancel();
	  assertEquals(0, ps.readDisplay(),0);
  }
